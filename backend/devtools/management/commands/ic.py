...
class Command(BaseCommand):
    ...
    Example usage:
        ./manage.py import_cities --datasource geonames --country NZ --country_category unitary_state --batch-size 60000
        ./manage.py import_cities --datasource geonames --country JP --country_category federal_state --batch-size 60000
    """
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--country_category",
            type=str,
            choices=['unitary_state', 'federal_state', 'quasi_federal_state'],
            required=True,
            help="Specify country category: unitary_state, federal_state, or quasi_federal_state",
        )
    ...
    def process_batch(self, batch, input_type, country, country_category, datasource, user, stats, region_cache, subregion_cache, city_cache, timezone_cache, region_slugs, subregion_slugs, city_slugs, admin_codes_to_add, subregion_names):
                ...
                if input_type == 'cities' and subregion:
                    ...
                    if city:
                        if location:
                            ...
                            location = Location(
                                city_id=city.id if city.pk else None,  # Will set later if new
        ...
        if new_cities:
            ...
            # Refresh city cache and set city_ids for locations
    ...
    def handle(self, *args, **options):
        ...
        country_category = options['country_category']
        if not country_code:
            return
