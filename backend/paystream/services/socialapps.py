...
# def ensure_google_socialapp():
#     """
#     Ensure exactly one Google SocialApp exists globally,
#     credentials are correct,
#     and it is bound ONLY to the current runtime Site.
...
#     # Ensure SITE_ID exists and is valid
#     try:
#         site = Site.objects.get(id=settings.SITE_ID)
#     except Site.DoesNotExist:
#         logger.error(
#             f"[SocialApp] SITE_ID={settings.SITE_ID} does not exist."
#         )
#         return
...
#     logger.info(
#         "[SocialApp] Bound to site '%s' (id=%s) | scope=%s | auth_params=%s",
#         site.domain,
#         site.id,
#         app.settings.get("scope"),
#         app.settings.get("auth_params"),
