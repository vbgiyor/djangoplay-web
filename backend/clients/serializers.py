...
class ClientBaseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'current_org_city', 'current_industry', 'current_org_joining_day',
            'current_country', 'current_region', 'current_state', 'other_organizations',
        ]
...
class ClientCreateSerializer(ClientBaseSerializer):
    other_organizations = serializers.PrimaryKeyRelatedField(
